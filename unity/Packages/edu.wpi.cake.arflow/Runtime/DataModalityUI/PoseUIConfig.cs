...
namespace CakeLab.ARFlow.DataModalityUIConfig
{
    ...
    public class PoseUIConfig : BaseDataModalityUIConfig
    {
        ...
        public PoseUIConfig(Transform transform, IClock clock, bool isBufferAvailable = true)
        {
        ...
        public PoseBuffer GetBufferFromConfig()
        {
            return new PoseBuffer(int.Parse(bufferSizeField.text), m_transform, m_Clock, int.Parse(samplingIntervalField.text));
        }
